...
/**
 * A InIpRange comparison operator.
 *
 * @author Justin Hileman <justin@shopopensky.com>
 */
class InIpRange extends VariableOperator implements Proposition
{
    /**
    ...
    public function evaluate(Context $context)
    {
        ...
        return $left->prepareValue($context)->inIpRange($right->prepareValue($context));
    }
